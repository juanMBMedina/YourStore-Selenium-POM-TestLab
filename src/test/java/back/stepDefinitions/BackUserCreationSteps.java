...
import pages.CreateAnUser;
import pages.GetAnUser;
...
public class BackUserCreationSteps {
    ...
    public void aUserIsCreated(String string) {
        userBack=builders.CreateAnUser.createAnUser();
        response = CreateAnUser.withInfo(userBack);
    }
